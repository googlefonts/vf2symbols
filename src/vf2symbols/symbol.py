...
class Symbol():
    ...
    def write_icon(self, symbol_wght_name, svg_path, svg_pen, x_size, y_size, from_font=False):
        ...
        path.attrib["d"] = self._draw_svg_path(svg_path, svg_pen, self.build_transformation(from_font, x_size, y_size))
        
        
    def build_transformation(self, from_font, x_size, y_size):
        if from_font:
